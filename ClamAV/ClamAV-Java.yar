rule JavaTrojanAdwind060153340
{
strings:
...
rule JavaTrojanAdwind160153350
{
strings:
	$hex0 = { 6a6176612f6c616e672f436c6173734c6f61646572 }
	$hex1 = { 6a6176612f6c616e672f7265666c6563742f4d6574686f64 }
...
rule JavaTrojanAdwind260153360
{
strings:
	$hex0 = { 6a6176612f6c616e672f436c6173734c6f61646572 }
	$hex1 = { 6a6176612f6c616e672f7265666c6563742f4d6574686f64 }
...
rule JavaExploitCVE_2013_14883
{
strings:
...
rule JavaExploitCVE_2012_172322
{
strings:
...
rule OsxTrojanFruitfly66654781
{
strings:
